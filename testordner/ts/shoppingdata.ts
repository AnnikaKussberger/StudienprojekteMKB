namespace Aufgabe12 {
    interface Artikelbeschreibung {
        bezeichnung: string;
        kurzBeschreibung: string[];
        preis: number;
        verfügbareArtikel: number;
        lieferDauer: string;
        aktion: boolean;
        erstmaligErschienen: number;
        höhe: number;
        breite: number;
        tiefe: number;
        imgSrc: string;
    ...
    var marimba: Artikelbeschreibung = {
...
*/
    ...
    var vibraphon: Artikelbeschreibung = {
   ...
   */ }
    ...
    var xylophon: Artikelbeschreibung = {
    ...
    */}
    ...
    var glockenspiel: Artikelbeschreibung = {
    ...
    var roehrenglocken: Artikelbeschreibung = {
    ...
    var pauken: Artikelbeschreibung = {
    ...
    var egeige: Artikelbeschreibung = {
    ...
    var schulterstuetze: Artikelbeschreibung = {
    ...
    var saiten: Artikelbeschreibung = {
    ...
    var drumset: Artikelbeschreibung = {
    ...
    var musikater: Artikelbeschreibung = {
    ...
    var mikrostaender: Artikelbeschreibung = {
    ...
    var mischpult: Artikelbeschreibung = {
    ...
    var absorber: Artikelbeschreibung = {
    ...
    var kopfhoerer: Artikelbeschreibung = {
    ...
    var monitorbox: Artikelbeschreibung = {
    ...
    //Sternchenaufga    
    //ERRAY
    var alleObjekte: Artikelbeschreibung[] = [marimba, vibraphon, xylophon, glockenspiel, roehrenglocken, pauken, geige, egeige, schulterstuetze, saiten, mikro, drumset, musikater, ralf, mikrostaender, xlr, mischpult, absorber, kopfhoerer, monitorbox];
...
*/
    ...
    function writeHTML(): void {
        ...
        function filterbyprice(priceLow: number, priceHigh: number): void {
            //console.log("Filter");

            var i: number = 0;

            while (i < alleObjekte.length) {
                var node: any = document.getElementById("Artikel_" + i);//"artikel_0"
    ...
    document.addEventListener('DOMContentLoaded', main);
            ...
            // Add EventListener - Funktion wird ausgeführt, sobald das DOM vollstÃ¤ndig geladen ist
